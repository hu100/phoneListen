...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setRadioChecked(int viewId, boolean isChecked) {
    ...
    public ViewHolder setSwitchButton(int viewId, String open, String close) {
        Switch sb = getView(viewId);
        sb.setTextOn(open);
        sb.setTextOff(close);
        return this;
    }
